...
```
DEPLOY_ENV=prod
DEPLOY_HOST=ploneutfpr.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
DOCKER_CONFIG=.docker
STACK_NAME=ploneutfpr-example-com
```
...
prod:
  hosts:
    ploneutfpr.example.com:
      ansible_user: root
      host: ploneutfpr
      hostname: ploneutfpr.example.com
```
...
Deploy the stack defined in `devops/stacks/ploneutfpr.example.com.yml` to the remote server with:
